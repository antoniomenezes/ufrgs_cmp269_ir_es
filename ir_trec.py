...
def generate_results(topics_dir, topics_filename, index_name, output_dir, output_filename):
...
generate_results(path+'/cmp269/gh95', 'topicos05.txt', 'gh95', path+'/cmp269/gh95', 'saida_es.txt')
